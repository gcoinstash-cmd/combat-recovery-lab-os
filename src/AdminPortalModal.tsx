              ...
              <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div key="DUAL-ZONE CONTRAST PLUNGES" className="p-3 rounded-lg bg-zinc-950 border border-zinc-800">
                      <span className="text-xs text-zinc-300 font-mono">DUAL-ZONE CONTRAST PLUNGES</span>
                    ...
                    <div key="MONTHLY RECOVERY SESSIONS" className="p-3 rounded-lg bg-zinc-950 border border-zinc-800">
                      <span className="text-xs text-zinc-300 font-mono">MONTHLY RECOVERY SESSIONS</span>
                    ...
                    <div key="MEDICAL IV PROTOCOLS" className="p-3 rounded-lg bg-zinc-950 border border-zinc-800">
                      <span className="text-xs text-zinc-300 font-mono">MEDICAL IV PROTOCOLS</span>
                    ...
                    <div key="PRO FIGHTER ENROLLMENT" className="p-3 rounded-lg bg-zinc-950 border border-zinc-800">
                      <span className="text-xs text-zinc-300 font-mono">PRO FIGHTER ENROLLMENT</span>
