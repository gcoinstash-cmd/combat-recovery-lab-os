...
export const AdminPortalModal: React.FC<AdminPortalModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    if (passcode.toLowerCase() === 'recovery2026') {
      ...
      <div className="relative w-full max-w-4xl bg-[#121214] border border-rose-500/30 rounded-2xl p-6 sm:p-8 shadow-2xl text-zinc-100 max-h-[90vh] overflow-y-auto">
        ...
        {!isAuthenticated ? (
          <div className="py-8 max-w-md mx-auto text-center">
            ...
            <h3 className="text-2xl font-bold tracking-tight mb-2">COMBAT RECOVERY LAB OS Portal</h3>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <input
                  ...
                  placeholder="Enter manager passkey (recovery2026)"
              ...
              {error && (
                <p className="text-red-400 text-xs font-mono">Invalid passkey. Use: recovery2026</p>
              )}
          ...
          <div>
            <div className="flex flex-wrap items-center justify-between gap-4 border-b border-zinc-800 pb-6 mb-6">
              <div>
                ...
                <h3 className="text-xl font-bold text-white">COMBAT RECOVERY LAB OS // BACK-OFFICE</h3>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                      ...
                      <div key="recovery_modalities" className="p-2.5 rounded bg-zinc-950 border border-zinc-800 text-xs font-mono text-zinc-300 flex items-center gap-1.5">
                        <CheckCircle className="w-3.5 h-3.5 text-emerald-400 flex-shrink-0" />
                        <span>recovery_modalities</span>
                      </div>
                    
                      <div key="member_sessions" className="p-2.5 rounded bg-zinc-950 border border-zinc-800 text-xs font-mono text-zinc-300 flex items-center gap-1.5">
                        <CheckCircle className="w-3.5 h-3.5 text-emerald-400 flex-shrink-0" />
                        <span>member_sessions</span>
                      </div>
                    
                      <div key="medical_intake_forms" className="p-2.5 rounded bg-zinc-950 border border-zinc-800 text-xs font-mono text-zinc-300 flex items-center gap-1.5">
                        <CheckCircle className="w-3.5 h-3.5 text-emerald-400 flex-shrink-0" />
                        <span>medical_intake_forms</span>
                      </div>
                    
                      <div key="iv_infusion_logs" className="p-2.5 rounded bg-zinc-950 border border-zinc-800 text-xs font-mono text-zinc-300 flex items-center gap-1.5">
                        <CheckCircle className="w-3.5 h-3.5 text-emerald-400 flex-shrink-0" />
                        <span>iv_infusion_logs</span>
                      </div>
            ...
            {activeTab === 'telemetry' && (
              <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div key="DUAL-ZONE CONTRAST PLUNGES" className="p-3 rounded-lg bg-zinc-950 border border-zinc-800">
                      <span className="text-xs text-zinc-500 font-mono">DUAL-ZONE CONTRAST PLUNGES</span>
                      <p className="text-lg font-bold text-rose-400 font-mono mt-0.5">{"38°F / 104°F"}</p>
                    </div>
                  
                    <div key="MONTHLY RECOVERY SESSIONS" className="p-3 rounded-lg bg-zinc-950 border border-zinc-800">
                      <span className="text-xs text-zinc-500 font-mono">MONTHLY RECOVERY SESSIONS</span>
                      <p className="text-lg font-bold text-rose-400 font-mono mt-0.5">{"2,150 VISITS"}</p>
                    </div>
                  
                    <div key="MEDICAL IV PROTOCOLS" className="p-3 rounded-lg bg-zinc-950 border border-zinc-800">
                      <span className="text-xs text-zinc-500 font-mono">MEDICAL IV PROTOCOLS</span>
                      <p className="text-lg font-bold text-rose-400 font-mono mt-0.5">{"14 FORMULATIONS"}</p>
                    </div>
                  
                    <div key="PRO FIGHTER ENROLLMENT" className="p-3 rounded-lg bg-zinc-950 border border-zinc-800">
                      <span className="text-xs text-zinc-500 font-mono">PRO FIGHTER ENROLLMENT</span>
                      <p className="text-lg font-bold text-rose-400 font-mono mt-0.5">{"84 ATHLETES"}</p>
                    </div>
            ...
            {activeTab === 'sql' && (
              <div className="p-4 rounded-xl bg-zinc-950 border border-zinc-800 font-mono text-xs text-zinc-300 overflow-x-auto">
                ...
                <div className="text-rose-400">ALTER TABLE recovery_modalities ENABLE ROW LEVEL SECURITY;</div>
                <div className="text-zinc-400 mt-1">CREATE POLICY "Allow authenticated read" ON recovery_modalities FOR SELECT USING (true);</div>
